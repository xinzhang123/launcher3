...
public class LauncherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (Binder.getCallingPid() != Process.myPid()
                && TABLE_NAME.equalsIgnoreCase(args.table)) {
    ...
    synchronized private void loadDefaultFavoritesIfNecessary() {
        ...
        if (sp.getBoolean(EMPTY_DATABASE_CREATED, true)) {
...
//            clearFlagEmptyDbCreated();
    ...
    public static class DatabaseHelper extends NoLocaleSQLiteHelper implements LayoutParserCallback {
        ...
        DatabaseHelper(Context context, Handler widgetHostResetHandler) {
            ...
            if (!tableExists(TABLE_NAME) || !tableExists(WorkspaceScreens.TABLE_NAME)) {
        ...
        private void removeOrphanedItems(SQLiteDatabase db) {
            ...
            //   AND container = -100"
            String removeOrphanedDesktopItems = "DELETE FROM " + TABLE_NAME +
                    " WHERE " +
            ...
            String removeOrphanedFolderItems = "DELETE FROM " + TABLE_NAME +
                    " WHERE " +
                    Favorites.CONTAINER + " <> " +
                    Favorites.CONTAINER_DESKTOP +
                    " AND "
        ...
        public long insertAndCheck(SQLiteDatabase db, ContentValues values) {
            return dbInsertAndCheck(this, db, TABLE_NAME, null, values);
        }
