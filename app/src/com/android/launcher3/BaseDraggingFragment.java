 ...
 */
public abstract class BaseDraggingFragment extends BaseActivity
    ...
    public static BaseDraggingFragment fromContext(Context context) {
        if (context instanceof BaseDraggingFragment) {
            return (BaseDraggingFragment) context;
        }
        return ((BaseDraggingFragment) ((ContextWrapper) context).getBaseContext());
    }
    ...
    public <T extends BaseDraggingFragment> void setOnStartCallback(OnStartCallback<T> callback) {
     ...
     */
    public interface OnStartCallback<T extends BaseDraggingFragment> {
