...
public class DragController implements DragDriver.EventListener, TouchController {
    ...
    public DragView startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        if (mOptions.systemDndStartPoint != null) {
            Log.d("DragController", "mOptions.systemDndStartPoint: x === " + mOptions.systemDndStartPoint.x + " y === " + mOptions.systemDndStartPoint.y);
            mMotionDownX = mOptions.systemDndStartPoint.x;
            mMotionDownY = mOptions.systemDndStartPoint.y;
        }
        Log.d("DragController", "startDrag: mMotionDownX === " + mMotionDownX + " mMotionDownY === " + mMotionDownY);
        Log.d("DragController", "startDrag: dragLayerX === " + dragLayerX + " dragLayerY === " + dragLayerY);
        Log.d("DragController", "startDrag: dragRegion.left === " + dragRegion.left + " dragRegion.top === " + dragRegion.top);
        ...
        Log.d("DragController", "startDrag: isAccessibleDrag === " + mOptions.isAccessibleDrag);
...
//        Log.d("DragController", "onDriverDragMove: x === " + x + " y === "+ y);
